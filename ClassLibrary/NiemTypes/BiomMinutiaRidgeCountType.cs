...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class BiomMinutiaRidgeCountType : IEquatable<BiomMinutiaRidgeCountType>
    { 
        /// <summary>
        /// An index identifier for a distant minutia point NIEM reference is biom:RidgeCountReferenceID
        /// </summary>
        /// <value>An index identifier for a distant minutia point NIEM reference is biom:RidgeCountReferenceID</value>
        ...
        /// </summary>
        /// <value>biomMinutiaRidgeCountType JSON-LD context</value>
        [JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public enum ContextEnum
        {
            /// <summary>
            /// Enum JSONLDContextsbiomMinutiaRidgeCountTypeContextJsonldEnum for ../JSON-LD_Contexts/biomMinutiaRidgeCountTypeContext.jsonld
            /// </summary>
            [EnumMember(Value = "../JSON-LD_Contexts/biomMinutiaRidgeCountTypeContext.jsonld")]
            JSONLDContextsbiomMinutiaRidgeCountTypeContextJsonldEnum = 0        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BiomMinutiaRidgeCountType {\n");
            sb.Append("  RidgeCountReferenceId: ").Append(RidgeCountReferenceId).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((BiomMinutiaRidgeCountType)obj);
        }

        /// <summary>
        /// Returns true if BiomMinutiaRidgeCountType instances are equal
        /// </summary>
        /// <param name="other">Instance of BiomMinutiaRidgeCountType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BiomMinutiaRidgeCountType other)
        {
            ...
            return 
                (
                    RidgeCountReferenceId == other.RidgeCountReferenceId ||
                    RidgeCountReferenceId != null &&
                    RidgeCountReferenceId.SequenceEqual(other.RidgeCountReferenceId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (RidgeCountReferenceId != null)
                    hashCode = hashCode * 59 + RidgeCountReferenceId.GetHashCode();
