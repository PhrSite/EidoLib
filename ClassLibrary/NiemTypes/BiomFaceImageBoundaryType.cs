...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class BiomFaceImageBoundaryType : IEquatable<BiomFaceImageBoundaryType>
    { 
        /// <summary>
        /// A shape of the boundary of a face image in a larger picture NIEM reference is biom:FaceImageBoundaryShapeCode
        /// </summary>
        /// <value>A shape of the boundary of a face image in a larger picture NIEM reference is biom:FaceImageBoundaryShapeCode</value>
        ...
        /// </summary>
        /// <value>biomFaceImageBoundaryType JSON-LD context</value>
        [JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public enum ContextEnum
        {
            /// <summary>
            /// Enum JSONLDContextsbiomFaceImageBoundaryTypeContextJsonldEnum for ../JSON-LD_Contexts/biomFaceImageBoundaryTypeContext.jsonld
            /// </summary>
            [EnumMember(Value = "../JSON-LD_Contexts/biomFaceImageBoundaryTypeContext.jsonld")]
            JSONLDContextsbiomFaceImageBoundaryTypeContextJsonldEnum = 0        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BiomFaceImageBoundaryType {\n");
            sb.Append("  ShapeCode: ").Append(ShapeCode).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((BiomFaceImageBoundaryType)obj);
        }

        /// <summary>
        /// Returns true if BiomFaceImageBoundaryType instances are equal
        /// </summary>
        /// <param name="other">Instance of BiomFaceImageBoundaryType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BiomFaceImageBoundaryType other)
        {
            ...
            return 
                (
                    ...
                    ShapeCode != null &&
                    ShapeCode.SequenceEqual(other.ShapeCode)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (ShapeCode != null)
                    hashCode = hashCode * 59 + ShapeCode.GetHashCode();
