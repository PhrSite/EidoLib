...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class EmIncidentNotificationType : IEquatable<EmIncidentNotificationType>
    { 
        /// <summary>
        /// An element for an emergency incident NIEM reference is em:EmergencyIncident
        /// </summary>
        /// <value>An element for an emergency incident NIEM reference is em:EmergencyIncident</value>
        ...
        /// </summary>
        /// <value>emIncidentNotificationType JSON-LD context</value>
        [JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public enum ContextEnum
        {
            /// <summary>
            /// Enum JSONLDContextsemIncidentNotificationTypeContextJsonldEnum for ../JSON-LD_Contexts/emIncidentNotificationTypeContext.jsonld
            /// </summary>
            [EnumMember(Value = "../JSON-LD_Contexts/emIncidentNotificationTypeContext.jsonld")]
            JSONLDContextsemIncidentNotificationTypeContextJsonldEnum = 0        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EmIncidentNotificationType {\n");
            sb.Append("  EmergencyIncident: ").Append(EmergencyIncident).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((EmIncidentNotificationType)obj);
        }

        /// <summary>
        /// Returns true if EmIncidentNotificationType instances are equal
        /// </summary>
        /// <param name="other">Instance of EmIncidentNotificationType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmIncidentNotificationType other)
        {
            ...
            return 
                (
                    EmergencyIncident == other.EmergencyIncident ||
                    EmergencyIncident != null &&
                    EmergencyIncident.SequenceEqual(other.EmergencyIncident)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (EmergencyIncident != null)
                    hashCode = hashCode * 59 + EmergencyIncident.GetHashCode();
